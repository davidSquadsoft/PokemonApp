...
$id_pkmn=$_GET['id_pkmn']; 
$sqlPickedPokemon = "select * from pokemon where id_pkmn=$id_pkmn";
$resultPickedPokemon=mysqli_query($mysqli,$sqlPickedPokemon);
$pokemonData=mysqli_fetch_assoc($resultPickedPokemon);
?>
    ...
    <div class="col-12 "> 
      ...
      <div class="row  shadow-sm   rounded pb-2 border border-1 mb-2">
        <div class="col-lg-4 col-12 d-grid">
          <label class="form-label mt-2 text-capitalize text-center"><?= $pokemonData['name'] ?> (<?= $pokemonData['apodo'] ?>)</label>
          <img src="<?= $pokemonData['sprite'] ?>" class="m-auto img-fluid" width="100px">
          <div class="d-flex justify-content-center">
          <img width='64px' src="img/icons/<?= $pokemonData['tipoa'] ?>.png" style="width:20px!important;" id="icon-element-atk-b" />
          <img width='64px' src="img/icons/<?= $pokemonData['tipob'] ?>.png" style="width:20px!important;" id="icon-element-atk-b" />
          </div>
      
     
        </div>
        <div class="col-lg-8 col-12 text-center justify-items-center d-flex row">
            <div class="col-6">
            <label class="form-label form-control shadow-sm mt-2" for="">Habilidad: </label>
            <?= $pokemonData['habilidad']=='' ? 'Sin Habilidad'  :  $pokemonData['habilidad'] ?>
           
            </div>  
            <div class="col-6">
            <label class="form-label form-control shadow-sm mt-2" for="">Efecto: </label>
            <?= $pokemonData['efecto_habilidad']=='' ? 'Sin Efecto'  :  $pokemonData['efecto_habilidad'] ?>
            </div>
      ...
      <div class="row fs-sm">
        <div class="col-lg-4 col-4 align-items-end d-grid  shadow-sm   rounded pb-2 border border-1 ">
          ...
          <input type="number" pattern="[1-9]" class="form-control bg-truewhite border-success fw-bold pt-0 pb-0 " value="<?= $pokemonData['atkfisico'] ?>" disabled name="atkfisico" required>
          <label class="form-label mt-2" for="">Atk Especial </label>
          <input type="number" pattern="[1-9]" class="form-control bg-truewhite border-success fw-bold pt-0 pb-0 " value="<?= $pokemonData['atkespecial'] ?>" disabled name="atkespecial" required>

        </div>
        <div class="col-lg-4 col-4 align-items-end d-grid  shadow-sm   rounded pb-2 border border-1">

          <label class="form-label mt-2" for="">Def Fisica </label>
          <input type="number" pattern="[1-9]" class="form-control bg-truewhite border-success fw-bold pt-0 pb-0 " value="<?= $pokemonData['deffisico'] ?>" disabled name="deffisico" required>
          <label class="form-label mt-2" for="">Def Especial </label>
          <input type="number" pattern="[1-9]" class="form-control bg-truewhite border-success fw-bold pt-0 pb-0 " value="<?= $pokemonData['defespecial'] ?>" disabled name="defespecial" required>
        </div>
        <div class="col-lg-4 col-4 align-items-end d-grid  shadow-sm   rounded pb-2 border border-1">
          <label class="form-label mt-2" for="">Agilidad </label>
          <input type="number" pattern="[1-9]" class="form-control bg-truewhite border-success fw-bold pt-0 pb-0 "value="<?= $pokemonData['agilidad'] ?>" disabled  name="agilidad" required>
          <label class="form-label mt-2" for="">Destreza </label>
          <input type="number" pattern="[1-9]" class="form-control bg-truewhite border-success fw-bold pt-0 pb-0 "value="<?= $pokemonData['destreza'] ?>" disabled  name="destreza" required>
        </div>
        <div class="col-12">
          <!-- MOVE A -->
